define([
    ...
    $.widget('lof.layer', {
        ...
        options: {
            ...
            navigationSelector: '#filter-block'  // Changed to #filter-block
        },
        ...
        ajaxSubmit: function (submitUrl) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.navigation) {
                        // Check if the filter block exists before replacing
                        if ($(self.options.navigationSelector).length) {
                            $(self.options.navigationSelector).replaceWith(res.navigation);
                        } else {
                            // Append if it doesn't exist
                            $(res.navigation).appendTo('#filter-container'); // Make sure #filter-container is the parent container
                        }

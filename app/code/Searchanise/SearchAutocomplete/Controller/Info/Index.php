...
use Magento\CatalogSearch\Model\ResourceModel\Fulltext\SearchCollection as MagentoSearchCollection;
use Magento\CatalogSearch\Model\ResourceModel\Fulltext\CollectionFactory as MagentoFulltextCollectionFactory;
use Magento\CatalogSearch\Model\ResourceModel\Advanced\CollectionFactory as MagentoAdvancedCollectionFactory;
            ...
            if ($profiler) {
                ...
                try {
                    ...
                    if (empty($productIds)) {
                        ...
                        $productIds = [];
                        $allProductIds = $this
                            ->apiProducts->getProductCollection()
                            ->setPageSize($numberIterations)
                            ->load();
                ...
                // Check collections
                $fullTextCollection        = $objectManager->get(MagentoCollection::class);
                $searchCollection          = $objectManager->get(MagentoSearchCollection::class);
                $collectionFactory         = $objectManager->get(MagentoFulltextCollectionFactory::class);
                $advancedCollectionFactory = $objectManager->get(MagentoAdvancedCollectionFactory::class);

                // Searchanise collection
                $need_class = \Searchanise\SearchAutocomplete\Model\ResourceModel\Product\Fulltext\Collection::class;
                ...
                try {
                    $itemCollectionProvider = $objectManager
                        // phpcs:ignore Magento2.PHP.LiteralNamespaces
                        ->get('Magento\CatalogSearch\Model\Search\ItemCollectionProviderInterface');
